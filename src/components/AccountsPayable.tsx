    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Gestión de créditos y pagos pendientes a proveedores</p>
        </div>
        <button
      ...
      {statement && (
        <div className="bg-white p-6 rounded-lg shadow">
          <h3 className="text-lg font-medium text-gray-900 mb-4">
            Estado de Cuenta - {statement.provider_name}
          </h3>
          ...
          <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {account.providers.name} - {account.providers.rfc}
                      </p>
                    </div>
                  </div>
            ...
            {accounts.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">No hay cuentas por pagar</h3>
                <p className="mt-1 text-sm text-gray-500">
                  Crea tu primera cuenta por pagar para comenzar a gestionar créditos con proveedores.
                </p>
              </div>
            )}
          </div>
